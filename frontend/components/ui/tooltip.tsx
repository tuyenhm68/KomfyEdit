...
interface TooltipProps {
  ...
  className?: string
  /** Extra classes on the bubble itself, e.g. to let long text wrap. */
  ...
  return (
    ...
    >
      ...
      {visible && ReactDOM.createPortal(
        <div
          className={cn(
            'fixed z-[99999] px-2.5 py-1.5 bg-white text-zinc-800 text-xs font-medium rounded-md shadow-md whitespace-nowrap pointer-events-none select-none',
            contentClassName,
          )}
          style={style}
        >
