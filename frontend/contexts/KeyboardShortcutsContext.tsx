...
const STORAGE_KEY = 'komfyedit-keyboard-shortcuts'
...
export function KeyboardShortcutsProvider({ children }: { children: React.ReactNode }) {
  ...
  const [activePresetId, setActivePresetId] = useState<string>(stored.current?.activePresetId || 'komfy-default')
  ...
  const deleteCustomPreset = useCallback((presetId: string) => {
    ...
    if (activePresetId === presetId) {
      setActivePresetId('komfy-default')
      setCustomLayout(null)
    }
  }, [activePresetId])
