...
export interface ActionDefinition {
  id: ActionId
  label: string
  category: 'Tools' | 'Transport' | 'Editing' | 'Marking' | 'Timeline' | 'General'
  description?: string
}
...
export const ACTION_REGISTRY: ActionDefinition[] = [
  ...
  { id: 'marker.add',       label: 'Add Marker',           category: 'Marking', description: 'Add marker at playhead position' },
  { id: 'marker.prev',      label: 'Previous Marker',      category: 'Marking', description: 'Jump playhead to previous marker' },
  { id: 'marker.next',      label: 'Next Marker',          category: 'Marking', description: 'Jump playhead to next marker' },
  // Timeline
...
export const KOMFY_DEFAULT_LAYOUT: KeyboardLayout = {
  ...
  'marker.add':        [k('m')],
  'marker.next':       [k('m', { shift: true })],
  'marker.prev':       [k('m', { alt: true }), k('m', { ctrl: true, shift: true })],
  // Timeline
  'timeline.zoomIn':    [k('='), k('+')],
  'timeline.zoomOut':   [k('-')],
...
export const PREMIERE_LAYOUT: KeyboardLayout = {
  ...
  'marker.add':        [k('m')],
  'marker.next':       [k('m', { shift: true })],
  'marker.prev':       [k('m', { ctrl: true, shift: true }), k('m', { alt: true })],
  // Timeline
  'timeline.zoomIn':    [k('=')],
  'timeline.zoomOut':   [k('-')],
